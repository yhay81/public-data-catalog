...
PDC is the short public name of **Public Data Catalog**. The repository name and
package identifiers remain `public-data-catalog` so existing links, registry
records, and integrations stay stable.
...
The primary wordmark is `PDC` with three signal points:
...
- Start with the concrete public-data question or outcome.
- Keep provenance, license, parameters, and limitations visible.
- Prefer “reviewed” and “verified” only when a contract or check actually
  supports the claim.
- Avoid claims of comprehensiveness, government endorsement, or guaranteed
  availability.
- Explain technical trust boundaries in plain language before naming the
